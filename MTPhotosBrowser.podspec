...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/rstx_reg@aliyun.com/MTPhotosBrowser'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'rstx_reg@aliyun.com' => 'secrimart@aliyun.com' }
  s.source           = { :git => 'https://github.com/rstx_reg@aliyun.com/MTPhotosBrowser.git', :tag => s.version.to_s }
